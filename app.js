...
*/
var y=prompt("DO YOU WANNA PLAY?");
if(y=='yes'|| y=='YES'||y=='Yes')
{
    
    var na=prompt("Please enter your name");
    document.querySelector('#intro').textContent=("WELCOME TO THE WORLD OF RISK"+na);
...
document.querySelector('.btn-hold').addEventListener("click",function()
{
    ...
    {
     var p=   document.getElementById('name-'+activePlayer).textContent=('Winner');
     p.bold;
    ...
    document.querySelector('.player-name ').classList.add('play');
    if(activePlayer==0)
    var s= 1;
    else
    var s=0;
    document.querySelector('.player-'+s+'-panel').classList.add('looser');
    gamePlaying=false;
...
dice=0;
    ...
    document.getElementsById("intro").innerHTML="WELCOME TO THE WORLD OF RISK";
}
